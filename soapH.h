...
#ifndef SOAP_TYPE_ns2__processImage_DEFINED
#define SOAP_TYPE_ns2__processImage_DEFINED
SOAP_FMAC3 void SOAP_FMAC4 soap_default_ns2__processImage(struct soap*, struct ns2__processImage *);
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_ns2__processImage(struct soap*, const struct ns2__processImage *);
SOAP_FMAC3 int SOAP_FMAC4 soap_out_ns2__processImage(struct soap*, const char*, int, const struct ns2__processImage *, const char*);
SOAP_FMAC3 struct ns2__processImage * SOAP_FMAC4 soap_in_ns2__processImage(struct soap*, const char*, struct ns2__processImage *, const char*);

SOAP_FMAC3 struct ns2__processImage * SOAP_FMAC4 soap_new_ns2__processImage(struct soap *soap, int n);
SOAP_FMAC3 int SOAP_FMAC4 soap_put_ns2__processImage(struct soap*, const struct ns2__processImage *, const char*, const char*);

#ifndef soap_write_ns2__processImage
#define soap_write_ns2__processImage(soap, data) ( soap_free_temp(soap), soap_begin_send(soap) || (soap_serialize_ns2__processImage(soap, data), 0) || soap_put_ns2__processImage(soap, data, "ns2:processImage", "") || soap_end_send(soap), (soap)->error )
#endif


#ifndef soap_PUT_ns2__processImage
#define soap_PUT_ns2__processImage(soap, URL, data) ( soap_free_temp(soap), soap_PUT(soap, URL, NULL, "text/xml; charset=utf-8") || (soap_serialize_ns2__processImage(soap, data), 0) || soap_put_ns2__processImage(soap, data, "ns2:processImage", "") || soap_end_send(soap) || soap_recv_empty_response(soap), soap_closesock(soap) )
#endif


#ifndef soap_PATCH_ns2__processImage
#define soap_PATCH_ns2__processImage(soap, URL, data) ( soap_free_temp(soap), soap_PATCH(soap, URL, NULL, "text/xml; charset=utf-8") || (soap_serialize_ns2__processImage(soap, data), 0) || soap_put_ns2__processImage(soap, data, "ns2:processImage", "") || soap_end_send(soap) || soap_recv_empty_response(soap), soap_closesock(soap) )
#endif


#ifndef soap_POST_send_ns2__processImage
#define soap_POST_send_ns2__processImage(soap, URL, data) ( soap_free_temp(soap), ( soap_POST(soap, URL, NULL, "text/xml; charset=utf-8") || (soap_serialize_ns2__processImage(soap, data), 0) || soap_put_ns2__processImage(soap, data, "ns2:processImage", "") || soap_end_send(soap) ) && soap_closesock(soap), (soap)->error )
#endif

SOAP_FMAC3 struct ns2__processImage * SOAP_FMAC4 soap_get_ns2__processImage(struct soap*, struct ns2__processImage *, const char*, const char*);

#ifndef soap_read_ns2__processImage
#define soap_read_ns2__processImage(soap, data) ( ((data) ? (soap_default_ns2__processImage(soap, (data)), 0) : 0) || soap_begin_recv(soap) || !soap_get_ns2__processImage(soap, (data), NULL, NULL) || soap_end_recv(soap), (soap)->error )
#endif


#ifndef soap_GET_ns2__processImage
#define soap_GET_ns2__processImage(soap, URL, data) ( soap_GET(soap, URL, NULL) || soap_read_ns2__processImage(soap, (data)), soap_closesock(soap) )
#endif


#ifndef soap_POST_recv_ns2__processImage
#define soap_POST_recv_ns2__processImage(soap, data) ( soap_read_ns2__processImage(soap, (data)) || soap_closesock(soap), (soap)->error )
#endif

#endif

#ifndef SOAP_TYPE_ns2__processImageResponse_DEFINED
#define SOAP_TYPE_ns2__processImageResponse_DEFINED
SOAP_FMAC3 void SOAP_FMAC4 soap_default_ns2__processImageResponse(struct soap*, struct ns2__processImageResponse *);
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_ns2__processImageResponse(struct soap*, const struct ns2__processImageResponse *);
SOAP_FMAC3 int SOAP_FMAC4 soap_out_ns2__processImageResponse(struct soap*, const char*, int, const struct ns2__processImageResponse *, const char*);
SOAP_FMAC3 struct ns2__processImageResponse * SOAP_FMAC4 soap_in_ns2__processImageResponse(struct soap*, const char*, struct ns2__processImageResponse *, const char*);

SOAP_FMAC3 struct ns2__processImageResponse * SOAP_FMAC4 soap_new_ns2__processImageResponse(struct soap *soap, int n);
SOAP_FMAC3 int SOAP_FMAC4 soap_put_ns2__processImageResponse(struct soap*, const struct ns2__processImageResponse *, const char*, const char*);

#ifndef soap_write_ns2__processImageResponse
#define soap_write_ns2__processImageResponse(soap, data) ( soap_free_temp(soap), soap_begin_send(soap) || (soap_serialize_ns2__processImageResponse(soap, data), 0) || soap_put_ns2__processImageResponse(soap, data, "ns2:processImageResponse", "") || soap_end_send(soap), (soap)->error )
#endif


#ifndef soap_PUT_ns2__processImageResponse
#define soap_PUT_ns2__processImageResponse(soap, URL, data) ( soap_free_temp(soap), soap_PUT(soap, URL, NULL, "text/xml; charset=utf-8") || (soap_serialize_ns2__processImageResponse(soap, data), 0) || soap_put_ns2__processImageResponse(soap, data, "ns2:processImageResponse", "") || soap_end_send(soap) || soap_recv_empty_response(soap), soap_closesock(soap) )
#endif


#ifndef soap_PATCH_ns2__processImageResponse
#define soap_PATCH_ns2__processImageResponse(soap, URL, data) ( soap_free_temp(soap), soap_PATCH(soap, URL, NULL, "text/xml; charset=utf-8") || (soap_serialize_ns2__processImageResponse(soap, data), 0) || soap_put_ns2__processImageResponse(soap, data, "ns2:processImageResponse", "") || soap_end_send(soap) || soap_recv_empty_response(soap), soap_closesock(soap) )
#endif


#ifndef soap_POST_send_ns2__processImageResponse
#define soap_POST_send_ns2__processImageResponse(soap, URL, data) ( soap_free_temp(soap), ( soap_POST(soap, URL, NULL, "text/xml; charset=utf-8") || (soap_serialize_ns2__processImageResponse(soap, data), 0) || soap_put_ns2__processImageResponse(soap, data, "ns2:processImageResponse", "") || soap_end_send(soap) ) && soap_closesock(soap), (soap)->error )
#endif

SOAP_FMAC3 struct ns2__processImageResponse * SOAP_FMAC4 soap_get_ns2__processImageResponse(struct soap*, struct ns2__processImageResponse *, const char*, const char*);

#ifndef soap_read_ns2__processImageResponse
#define soap_read_ns2__processImageResponse(soap, data) ( ((data) ? (soap_default_ns2__processImageResponse(soap, (data)), 0) : 0) || soap_begin_recv(soap) || !soap_get_ns2__processImageResponse(soap, (data), NULL, NULL) || soap_end_recv(soap), (soap)->error )
#endif


#ifndef soap_GET_ns2__processImageResponse
#define soap_GET_ns2__processImageResponse(soap, URL, data) ( soap_GET(soap, URL, NULL) || soap_read_ns2__processImageResponse(soap, (data)), soap_closesock(soap) )
#endif


#ifndef soap_POST_recv_ns2__processImageResponse
#define soap_POST_recv_ns2__processImageResponse(soap, data) ( soap_read_ns2__processImageResponse(soap, (data)) || soap_closesock(soap), (soap)->error )
#endif
